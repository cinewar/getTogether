...
export default class JitsiMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Get Togetherin it.
     *
    ...
    /**
     * Getter for the large video element in Get Together.
     *
    ...
    /**
     * Getter for the prejoin video element in Get Together.
     *
    ...
    /**
     * Getter for participant specific video element in Get Together.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Get Together
    ...
    /**
     * Removes the listeners and removes the Get Togetherframe.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Get Together.
     *
