...
var config = {
    ...
    // Moves all Get Together'beforeunload' logic (cleanup, leaving, disconnecting, etc) to the 'unload' event.
    ...
    */
     ...
     * which is retrieved internally by Get Together) (e.g. https://meet.jit.si/someMeeting
