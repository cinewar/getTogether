...
/**
 * Allow users to embed a Get Togethering in an iframe.
 *
...
function EmbedMeeting({ t, url }: IProps) {
    ...
    /**
     * Get the embed code for a Get Togethering.
     *
    ...
    return (
        <Dialog cancel={{ hidden: true }} ok={{ hidden: true }} titleKey={'embedMeeting.title'}>
