...
const Label = ({ accessibilityText, className, color, icon, iconColor, id, onClick, text }: IProps) => {
    ...
    return (
        <div
            className={cx(classes.label, onClick && classes.clickable, color && classes[color], className)}
            id={id}
            onClick={onClick}
