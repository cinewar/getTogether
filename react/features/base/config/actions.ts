...
/**
 * Signals that the configuration (commonly known in Get Togetheras config.js)
...
/**
 * Signals that a configuration (commonly known in Get Togetheras config.js)
...
/**
 * Stores a specific Get Togetherconfig.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The Get Togetherconfig.js to store.
 * @returns {Function}
 */
