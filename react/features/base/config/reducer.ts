 ...
 * JitsiMeetJS#init(). The app will download config.js from the Get Together
 ...
 * The app will download config.js from the Get Togetherdeployment and take its
 ...
 * config.js from the Get Togetherdeployment and take its values into account but
...
function _setConfig(state: IConfig, { config }: { config: IConfig }) {
    ...
    const newState = merge(
        ...
        // downloaded from the Get Togetherdeployment because the former contains
