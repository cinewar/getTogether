# Get Together- redux state persistence

Get Togetherhas a persistence layer that persists specific subtrees of the redux
...
When it's done, Get Togetherwill automatically persist these subtrees and
