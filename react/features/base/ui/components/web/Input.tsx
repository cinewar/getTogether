    ...
    (
        ...
        return (
            <div className={cx(styles.inputContainer, className)}>
                {label && (
                    <label className={cx(styles.label, isMobile && 'is-mobile')} htmlFor={id}>
                        {label}
                    </label>
                )}
                <div className={styles.fieldContainer}>
                    ...
                    {showClearIcon && (
                        <button className={styles.clearButton}>
                            <Icon onClick={clearInput} size={20} src={IconCloseCircle} />
                        </button>
                    )}
                </div>
                {bottomLabel && (
                ...
                {!bottomLabel && hiddenDescription && (
                    <HiddenDescription id={hiddenDescriptionId}>{hiddenDescription}</HiddenDescription>
                )}
            </div>
        );
    }
