...
export class Participant {
    ...
    /**
     * Whether the current frame is the main frame. This could coincide with the Get Togetherframe (when it's loaded
    ...
    /**
     * Switches to the main frame context (outside the iFrame; where the Get TogetheriFrame API is available).
     *
    ...
    /**
     * Switches to the iFrame context (inside the iFrame; where the Get Togetherapplication runs).
     *
     * If this Participant was initialized with iFrameApi=false this is a no-op.
     */
